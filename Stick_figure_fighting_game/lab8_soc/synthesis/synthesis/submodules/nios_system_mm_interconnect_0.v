...
module nios_system_mm_interconnect_0 (
	...
	wire   [13:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> keycode1_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> otg_hpi_cs_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> otg_hpi_address_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                              // otg_hpi_address_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [13:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> otg_hpi_address_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> otg_hpi_data_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> otg_hpi_r_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                              // otg_hpi_r_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [13:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> otg_hpi_r_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> otg_hpi_w_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // otg_hpi_w_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [13:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> otg_hpi_w_s1_agent:cp_channel
	...
	wire  [106:0] otg_hpi_address_s1_agent_rp_data;                                                   // otg_hpi_address_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [106:0] otg_hpi_r_s1_agent_rp_data;                                                         // otg_hpi_r_s1_agent:rp_data -> router_014:sink_data
	...
	wire  [106:0] otg_hpi_w_s1_agent_rp_data;                                                         // otg_hpi_w_s1_agent:rp_data -> router_015:sink_data
